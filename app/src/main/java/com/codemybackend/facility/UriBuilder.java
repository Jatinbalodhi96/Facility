...
public class UriBuilder {
    ...
    public String getURL(String stateandUt) {

        String resource_id = "e16c75b6-7ee6-4ade-8e1f-2cd3043ff4c9";
        String api_key = "bacdc4a9814fb08420fda85d2cc0c4bd";
        String filters = stateandUt;
        String fields = "city,id,state,h_name,address,pincode,email,contact,latitude,longitude";
        String sort = "[city]";
        ...
        final String QUERY_SORT = "sort[h_name]";
    ...
    public String getURL(int pincode) {

        String resource_id = "e16c75b6-7ee6-4ade-8e1f-2cd3043ff4c9";
        String api_key = "bacdc4a9814fb08420fda85d2cc0c4bd";
        String filters = String.valueOf(pincode);
        String fields = "city,id,state,h_name,address,pincode,email,contact,latitude,longitude";
        String sort = "[city]";
        ...
        final String QUERY_RESOURCE_ID = "resource_id";
        final String QUERY_API_KEY = "api-key";
        final String QUERY_FILTERS = "filters[pincode]";
        final String QUERY_FIELDS = "fields";
        final String QUERY_SORT = "sort[h_name]";
